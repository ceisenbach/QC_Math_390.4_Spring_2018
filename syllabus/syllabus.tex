...
\newcommand{\coursewebpage}{\href{https://github.com/kapelner/QC_Math_390.4_Spring_2018}{course homepage}}

\newcommand{\qu}[1]{``#1''}


\title{MATH 390.4 Spring 2018 (4 credits) \\ Course Syllabus}
...
Course Homepage & \href{https://github.com/kapelner/QC_Math_390.4_Spring_2018}{https://github.com/kapelner/QC\_Math\_390.4\_Spring\_2018} \\
\end{tabular}
\end{table}

\section*{Course Overview}

MATH 390.4. Data Science via Machine Learning and Statistical Modeling with the R Language. 4 hr.; 4 cr. Prereq.: MATH 241 (intro to probablity and statistics), MATH 231 (intro to linear algebra), CSCI 111 (intro to programming) or equivalents. Recommended: ECON 382 (intro to economentrics) or equivalent, MATH 633 (statistical inference) or equivalent. Philosophy of modeling and learning using data. Prediction and inference via the ordinary linear model (using matrices), ridge regression, logistic regression and survival analysis. Prediction with machine learning including neural nets and deep learning, tree methods e.g. CART, Random Forests and Gradient Boosting along with model validation. We will also cover measures of parimony (e.g. AIC), out of sample validation, inference versus prediction, variable selection (including the lasso), principal components analysis, correlation versus causation, randomized experiments versus observational studies, the bootstrap and more. Demos will be in the \texttt{R} language as well as a substantial part of the homework. We will also cover visualization using the \texttt{ggplot} library and munging using \texttt{data.table}. Final project reports on a prediction model for a real-world dataset. \emph{Spring} \\
...
\paragraph{Popular Books:} We will also be reading the non-fiction novel \qu{The Signal and the Noise} by Nate Silver which can also be purchased on \href{https://www.amazon.com/Signal-Noise-Many-Predictions-Fail-but/dp/0143125087}{Amazon}. This is \textit{required} --- you will have homework questions directly from this book. We will also be reading \qu{Preditive Analytics, Data Mining and Big Data} by Steven Finlay that can be purchased on \href{https://www.amazon.com/Predictive-Analytics-Data-Mining-Misconceptions/dp/1349478687}{Amazon}. 
...
\paragraph{Source Control:} You will be expected to use \texttt{git} and have a \url{github.com} account with a repository named \texttt{QC\_MATH\_390.4\_Spring\_2018}. You will use this repository to submit coding homework assignments (and theory assignments if you use \LaTeX).
...
\item The final examination will be Thursday, May 23 8:30-10:30AM in KY277 with a review on the prior Wednesday, May 16. 
\end{itemize}
...
\item From midterm II until the final. The final (or paper) is cumulative and covers all course material.
\end{enumerate}
